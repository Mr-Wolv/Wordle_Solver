...
In normal Wordle mode, the *solver* is exactly that — a solver. It does not need more than 5 guesses and averages a crisp ~3.6 turns. It was, I dare say, a beautiful, successful experiment.
